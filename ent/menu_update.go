...
func (mu *MenuUpdate) SetPrice(i int) *MenuUpdate {
...
func (mu *MenuUpdate) AddPrice(i int) *MenuUpdate {
...
func (mu *MenuUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := mu.mutation.AddedPrice(); ok {
		_spec.AddField(menu.FieldPrice, field.TypeInt, value)
	}
...
// SetPrice sets the "price" field.
func (muo *MenuUpdateOne) SetPrice(i int) *MenuUpdateOne {
...
// AddPrice adds i to the "price" field.
func (muo *MenuUpdateOne) AddPrice(i int) *MenuUpdateOne {
